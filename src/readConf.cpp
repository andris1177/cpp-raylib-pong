...
void Game::ReadConf::ReadFile()
{
    ...
    while (!in.eof())
    {
        ...
        else if (line == "PLAYER1_UP")
        {
           player1_up = ConvertKeyControll(value);
        }

        else if (line == "PLAYER1_DOWN")
        {
           player1_down = ConvertKeyControll(value);
        }

        else if (line == "PLAYER2_UP")
        {
           player2_up = ConvertKeyControll(value);
        }
...
int Game::ReadConf::ConvertKeyControll(const std::string& key)
{
